...
def _kopf(listen_id: int, jahrgang: int) -> dict:
    return {
        "id": listen_id, "title": f"Jahrgang {jahrgang}", "grade": jahrgang, "package": True,
...
class _Schuljahre:
    ...
    def get_booklists(self, schoolyear_id: str) -> list[dict]:
        ...
        return [_kopf(1296, 6), _kopf(1295, 5)]
